...
import com.example.varun.wardrobe.NavigationActivity;
import com.example.varun.wardrobe.NavigationActivity;
import com.example.varun.wardrobe.R;
import com.example.varun.wardrobe.utils.PrefsHelper;
import com.example.varun.wardrobe.R;
import com.example.varun.wardrobe.login;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(log.getSuccess().equals("true")){
                            ...
                            com.example.shivani.miete.utils.PrefsHelper.getPrefsHelper(LoginActivity.this).savePref(com.example.shivani.miete.utils.PrefsHelper.PREF_TOKEN,log.getToken());
                            Log.e("Old token",(String) com.example.shivani.miete.utils.PrefsHelper.getPrefsHelper(LoginActivity.this).getPref(com.example.shivani.miete.utils.PrefsHelper.PREF_TOKEN,"Cool"));
                            responseAnekeBaad();
                        }
                        else{
